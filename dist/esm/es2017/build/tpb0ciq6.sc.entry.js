...
class AgcSorghumHarvestLoss {
    ...
    render() {
        return (h("div", null,
            h("form", { onSubmit: e => e.preventDefault(), ref: c => (this.form = c), "data-wizard": "agc-sorghum-harvest-loss", "data-wizard-mode": this.mode, class: "agc-wizard" },
                h("slot", null),
                h("section", { "data-wizard-section": "0" },
                    h("div", { class: "agc-wizard__field" },
                        ...
                        h("p", { "data-i18n": `hints.kernels-counted` }, "\u2BA4 Enter a value.")),
                ...
                h("section", { "data-wizard-section": "1" },
                    h("div", { class: "agc-wizard__field" },
                        ...
                        h("p", { "data-i18n": `hints.loss-area` }, "\u2BA4 Enter a value.")),
    ...
    static get is() { return "agc-sorghum-harvest-loss"; }
